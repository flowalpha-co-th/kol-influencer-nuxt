    ...
    <section class="py-20 bg-gradient-to-br from-primary/5 via-white to-primary/10">
      <div class="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto">
          <UiBadge variant="secondary" class="bg-primary/10 text-primary border-0 mb-6">FAQ</UiBadge>
          <h1 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">Frequently Asked Questions</h1>
          <p class="text-xl text-gray-600">Everything you need to know about joining our platform.</p>
        </div>
      </div>
    </section>
      ...
      <div class="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-xl mx-auto">
          <div class="relative">
            ...
            <UiInput v-model="searchQuery" placeholder="Search for answers..." class="pl-12 h-14 text-lg" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
        <UiCard class="border-0 shadow-xl bg-gradient-to-r from-primary to-red-600">
          <UiCardContent class="p-12 text-center text-white">
            ...
            <NuxtLink to="/contact">
              <UiButton variant="secondary" size="lg">Contact Us</UiButton>
            </NuxtLink>
          </UiCardContent>
        </UiCard>
      </div>
